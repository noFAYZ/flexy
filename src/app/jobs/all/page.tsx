...
const jobsData = [
  {
    ...
    client: {
      ...
      rating: 4.9,
      description:
        "Leading DeFi company specializing in innovative financial protocols and pushing the boundaries of decentralized finance.",
    },
    budget: 12000,
    duration: "3 months",
    difficulty: 5,
  ...
  },
  {
    ...
    client: {
      ...
      rating: 4.7,
      description:
        "Fast-growing startup building next-gen trading platforms to revolutionize the crypto trading experience for both retail and institutional users.",
    },
    budget: 8000,
    duration: "2 months",
    difficulty: 3,
  ...
  },
  {
    ...
    client: {
      ...
      rating: 4.8,
      description:
        "Pioneering research and development in zero-knowledge cryptography, focused on creating scalable and privacy-preserving blockchain solutions.",
    },
    budget: 15000,
    duration: "6 months",
    difficulty: 5,
  ...
  },
  {
    id: 4,
    title:
      "Full-Stack NFT Marketplace Developer with Focus on Performance and User Experience",
    excerpt:
      "Build a high-performance, user-centric NFT marketplace with advanced trading features and multi-chain support.",
    description:
    ...
    client: {
      ...
      rating: 4.5,
      description:
        "Revolutionizing the digital art world through blockchain technology, connecting artists, collectors, and investors on a global scale.",
    },
    budget: 10000,
    duration: "4 months",
    difficulty: 4,
  ...
  },
  {
    ...
    client: {
      ...
      rating: 4.6,
      description:
        "Data-driven crypto investment firm with a focus on algorithmic trading and quantitative strategies in the digital asset space.",
    },
    budget: 9000,
    duration: "3 months",
    difficulty: 3,
  ...
  },
  {
    ...
    client: {
      ...
      rating: 4.9,
      description:
        "Industry-leading blockchain security firm ensuring the safety of Web3 projects through rigorous audits and cutting-edge security practices.",
    },
    budget: 13000,
    duration: "2 months",
    difficulty: 5,
  ...
  },
  {
    ...
    client: {
      ...
      rating: 4.7,
      description:
        "Non-profit organization dedicated to advancing blockchain technology through open-source development and academic research partnerships.",
    },
    budget: 18000,
    duration: "6 months",
    difficulty: 5,
  ...
  },
  {
    ...
    client: {
      ...
      rating: 4.3,
      description:
        "Startup creating the next generation of decentralized social networks, focusing on user data ownership and content monetization.",
    },
    budget: 5000,
    duration: "Ongoing",
    difficulty: 2,
  ...
  },
  {
    ...
    client: {
      ...
      rating: 4.5,
      description:
        "Innovative gaming studio blending blockchain technology with AAA game development to create immersive and economically viable GameFi experiences.",
    },
    budget: 11000,
    duration: "2 months",
    difficulty: 4,
...
const menuItems = [
  { icon: Globe, text: "All Jobs", link: "all", count: jobsData.length },
  {
    ...
    text: "Recommended",
    link: "recommended",
    count: jobsData.filter((job) => job.experienceLevel === "Expert").length,
  },
      ...
      <div className="px-4 sm:px-6 lg:px-8 py-8 ">
        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              <h1
                className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-orange-500 via-pink-500 to-purple-500 
